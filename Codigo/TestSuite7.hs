...
testSuite7 = test [
    ...
    "publicacionesQueLeGustanA 3 - Al usuario le gusta mas de una publicacion " ~: expectAny (publicacionesQueLeGustanA ts7_redsocial3 (3,"Lujan")) [[((1,"Maximiliano"),"Yo opino que si opino un pensamiento",[(3,"Lujan"),(2,"Mauricio")]),((4,"Santiago"),"Que me venga a la cabeza hago critica social",[(3,"Lujan"),(1,"Maximiliano")])],[((4,"Santiago"),"Que me venga a la cabeza hago critica social",[(3,"Lujan"),(1,"Maximiliano")]),((1,"Maximiliano"),"Yo opino que si opino un pensamiento",[(3,"Lujan"),(2,"Mauricio")])]]
 ]
