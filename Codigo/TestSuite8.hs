...
ts8_redsocial1 = ([(1,"Maximiliano"),(2,"Lujan")],[],[]) --false 
ts8_redsocial2 = ([(1,"Maximiliano"),(2,"Lujan"),(3,"Mauricio")],[],[((1,"Maximilino"),("Hola mundo"),[])]) --false
ts8_redsocial3 = ([(1,"Maximiliano"),(2,"Lujan"),(3,"Mauricio")],[],[((1,"Maximilino"),("Esta es mi publicacion que a alguien le va a gustar"),[(2, "Lujan")])]) --false
...
testSuite8 = test [
    " lesGustanLasMismasPublicaciones 1 - Red social sin publicaciones" ~: (lesGustanLasMismasPublicaciones ts8_redsocial1 (1,"Maximiliano") (2,"Lujan")) ~?= False,
    " lesGustanLasMismasPublicaciones 2 - Red social con varios ususarios y una publicación sin me gusta" ~: (lesGustanLasMismasPublicaciones ts8_redsocial2 (2,"Lujan") (3,"Mauricio")) ~?= False,
