...
ts2_redsocial4 = ([(1,"Maximiliano"),(2,"Lujan"),(3, "Mauricio"),(4, "Santiago"),(5, "Juan"),(6, "Carlos"),(7, "Bodoque")],[ts2_relacion1, ts2_relacion2, ts2_relacion3, ts2_relacion4, ts2_relacion5],[])
ts2_redsocial5 = ([(1,"Maximiliano"),(2,"Lujan"),(3,"Santiago")], [((3,"Santiago"),(2, "Lujan"))],[])
...
testSuite2 = test [
    ...
    "amigosDe 5 - Red con muchos usuarios pero con usuario de entrada sin amigos" ~: (amigosDe ts2_redsocial5 (1, "Maximiliano")) ~?= []
 ]
