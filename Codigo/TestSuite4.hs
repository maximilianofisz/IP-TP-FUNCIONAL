...
testSuite4 = test [
    ...
    "usuarioConMasAmigos 2 - Red social con varios usuarios, dos de ellos con la misma cantidad de amigos" ~: expectAny (usuarioConMasAmigos ts4_redsocial2) [(1, "Maximiliano"), (2,"Lujan")],
    ...
    "usuarioConMasAmigos 4 - Red social con los usuarios teniendo a todos los usuarios como amigos" ~: expectAny (usuarioConMasAmigos ts4_redsocial4) [(1,"Maximiliano"),(2,"Lujan"),(3,"Mauricio"),(4, "Santiago"),(5,"Pilar")]
    ]
