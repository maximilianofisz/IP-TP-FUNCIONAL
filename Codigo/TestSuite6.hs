...
testSuite6 = test [
    ...
    "publicacionesDe 3 - El usuario tiene multiples publicaciones " ~: expectAny (publicacionesDe ts6_redsocial3 (1,"Maximiliano")) [[((1,"Maximiliano"),"Hay que ser, siempre el mejor",[]),((1,"Maximiliano"),"Mejor que nadie mas!",[])],[((1,"Maximiliano"),"Mejor que nadie mas!",[]),((1,"Maximiliano"),"Hay que ser, siempre el mejor",[])]]
 ]
